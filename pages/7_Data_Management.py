...
MATCH_SCOUT_COLLECTION = "match_scout_data"  # Renamed from scouting_data
PIT_SCOUT_COLLECTION = "pit_scout_data"
ARCHIVED_MATCH_SCOUT_COLLECTION = "archived_match_scout_data"  # Renamed from archived_scouting_data
...
pit_rating_fields = []  # Pit Scouting has no rating fields
...
with main_tabs[1]:
    ...
    with pit_tabs[2]:
        ...
        if not pit_data.empty:
            ...
            st.warning(f"This action will permanently delete all records in the {PIT_SCOUT_COLLECTION} collection. This cannot be undone.")
    ...
    with pit_tabs[4]:
        ...
        st.markdown(f"Upload a CSV file containing pit scouting data. The CSV should include all required fields matching the pit scouting form structure.")
